'''
Get each digit in x from right to left
res = res * 10 + digit

But check for integer overflow before adding to res
1. if res > MAX or res < MIN, return 0
2. if res == MAX//10 and digit > rightmost digit in MAX, return 0
   same for res == MIN//10
   
Time: O(digits in 2^31) = O(1)
Space: O(1)
'''
